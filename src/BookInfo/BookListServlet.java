...
public class BookListServlet extends HttpServlet {
	...
	public BookList getBookList (int pageNumber) throws ServletException, IOException {
			String SQL = "";
			...
			try {
				SQL = "SELECT * FROM bookList ORDER BY bookID ASC LIMIT " + pageNumber * 5 + ", " + pageNumber * 5 + 6;				
