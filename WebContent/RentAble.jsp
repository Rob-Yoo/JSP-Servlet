...
<body>
	...
	<div class="p-1 mt-3 ml-3 bg-dark text-white text-center rounded-pill" style="max-width: 20%">
		<h3 class="mt-1 mb-0">대여 가능 도서</h3>	
	</div>
	<section>
		...
		<c:if test ="${not doneLoop}">
	    	...
	    	<li class="page-item">
				...
				<c:if test="${pageNumber > 0}">
					<a class = "page-link" href="./rentAble?pageNumber=${pageNumber - 1}">이전</a>
				</c:if>
	    	</li>
	    	<li>
				...
				<c:if test="${size == 6 or size > 6}">
					<a class = "page-link" href="./rentAble?pageNumber=${pageNubmer + 1}">다음</a>
				</c:if>
  			</li>
	    </ul>
