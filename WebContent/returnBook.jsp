...
<body>
		...
		<c:if test ="${not doneLoop}">
			...
			<div class="card mt-5 mx-auto" style="max-width: 70%">
	  			...
	  			<div class = "card-footer">
	  				<div class="row">
	    				<div class="text-left col-7 mt-2">
		    				대여 가능 : <span class="text-danger">NO</span>
		    				| 대여 횟수: <b>${BookList.rentCount[cnt]}</b>
		    			</div>
		    			<div class="text-right col-5 mx-auto">
		    				<form action="returnBook?bookID=${BookList.bookID[cnt]}" method="post">	    					
	...
	<ul class= "pagination justify-content-center mt-3">
		...
		<c:if test="${pageNumber > 0}">
			<a class = "page-link" href="./renturnBook?pageNumber=${pageNumber - 1}">이전</a>
		</c:if>
	   	</li>
	   	<li>
		...
		<c:if test="${size == 6 or size > 6}">
			<a class = "page-link" href="./renturnBook?pageNumber=${pageNubmer + 1}">다음</a>
		</c:if>
  		</li>
	</ul>
