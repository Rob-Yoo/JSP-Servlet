		...
		<c:if test ="${not doneLoop}">
	    	...
	    	<li class="page-item">
				...
				<c:if test="${pageNumber > 0}">
					<a class = "page-link" href="./popularBook?pageNumber=${pageNumber - 1}">이전</a>
				</c:if>
	    	</li>
	    	<li>
				...
				<c:if test="${size == 6 or size > 6}">
					<a class = "page-link" href="./popularBook?pageNumber=${pageNubmer + 1}">다음</a>
				</c:if>
  			</li>
	    </ul>
