	...
	<section class="mt-5 ml-5 mx-auto" style="max-width: 50%; height: auto;">
		<div class="card mb-3">
		 	...
		 	<div class="card-body" style="height: 213px;">
			  	<h5 class="card-title">기증 실패</h5>
			 	<p class="card-text">도서를 기증하는데 실패했습니다.<br>이미 존재하는 도서 ID를 입력하신 것은 아닌지 확인해주기 바랍니다.
			 		<br>회원님이 입력하신 도서ID는 <span class="text-primary">${bookID}</span> 입니다.
			 	</p><br>
			 	<p class="card-text"><small class="text-muted"><a href="donateBook">되돌아가기</a></small></p>
	 	 	</div>
		</div>
	</section>
